    ...
    if (selectedNodes.length > 0) {
      for (let i = 0; i < selectedNodes.length; i++) {
        if (this.body.nodes[selectedNodes[i]].isCluster === true) {
          ...
          //this.body.data.nodes.getDataSet().remove(cluster.containedNodes);
          ...
          console.log(selectedNodes)
          //this.body.data.edges.getDataSet().remove(culster_nodes)
          //return;
        }
      }
      ...
      for (let i = 0; i < selectedEdges.length; i++) {
          let clusterInEdge = Object.assign({}, this.body.nodes[selectedEdges[i]])
